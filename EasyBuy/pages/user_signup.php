...
<head>
    ...
    <title>Easy Buy.lk | signup</title>
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a  style="font-size: 25px;" href="../index.php" class="navbar-brand" rel="tooltip" title="Group 08." data-placement="bottom">
                    Easy Buy.lk
                </a>
...
?>
    ...
    <div class="page-header" filter-color="gray">
        <div class="page-header-image" style="background-image:url(../assets/img/3.jpg)"></div>
        <div class="container">
                ...
                <div class="card card-login card-plain">
                    <form class="form" method="post" action="">
                        ...
                        <div class="footer text-center">
                            <button type="submit" class="bbtn btn-primary btn-round btn-lg btn-block" id="submit" name="submit" style="background: green;">
                                 Create account

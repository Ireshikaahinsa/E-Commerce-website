...
?>   
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            ...
                            <img class="d-block" src="../assets/img/<?php echo $res['prod_pic1']; ?>" alt="First slide" width="400px" height="300px">
                            <?php else: ?>
                        ...
                        <div class="carousel-item">
                            ...
                            <img class="d-block" src="../assets/img/<?php echo $res['prod_pic2']; ?>" alt="Second slide" width="400px" height="300px">
                            <?php else: ?>
                            <img src="../uploads/default.png">
                            <?php endif; ?>
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item">
                            ...
                            <img class="d-block" src="../assets/img/<?php echo $res['prod_pic3']; ?>" alt="Third slide" width="400px" height="300px">
                            <?php else: ?>
                            <img src="../uploads/default.png">
                            <?php endif; ?>
                            <div class="carousel-caption d-none d-md-block">
        ...
        <ul><b>Price: </b>
        <?php echo 'RS &nbsp'.$res['prod_price'].''; ?>
        </ul>
        <ul>
